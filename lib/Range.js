...
var Range = /** @class */ (function (_super) {
    ...
    function Range(props) {
        ...
        _this.onResize = function () {
            utils_1.translateThumbs(_this.getThumbs(), _this.getOffsets(), _this.props.rtl, _this.props.rotate90Deg);
    ...
    Range.prototype.componentDidMount = function () {
        ...
        utils_1.translateThumbs(this.getThumbs(), this.getOffsets(), this.props.rtl, this.props.rotate90Deg);
    ...
    Range.prototype.componentDidUpdate = function (prevProps, prevState) {
        var _a = this.props, max = _a.max, min = _a.min, step = _a.step, values = _a.values, rtl = _a.rtl, rotate90Deg = _a.rotate90Deg;
        ...
        utils_1.translateThumbs(this.getThumbs(), this.getOffsets(), rtl, rotate90Deg);
